                        ...
                        <div class="card-body">
                            <form action="{{ url('/store') }}" method="POST">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <button class="btn btn-success" type="submit"><i class="menu-icon fa fa-plus "></i> Tambah</button>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" name="NRK" class="form-control @error('NRK') is-invalid @enderror" value="{{ old('NRK') }}" required="">
                                        @error('NRK')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="number" name="phl" class="form-control @error('phl') is-invalid @enderror" value="{{ old('phl') }}">
                                        @error('phl')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="jabatan_id" class="form-control @error('jabatan_id') is-invalid @enderror">
                                            ...
                                            @foreach ($master_jabatan as $item)
                                                <option value="{{ $item->id }}" {{ old('jabatan_id') == $item->id ? 'selected' : null }}>{{ $item->kode_jabatan }}</option>
                                            @endforeach
                                        </select>
                                        @error('jabatan_id')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="group_piket" class="form-control @error('group_piket') is-invalid @enderror" value="{{ old('group_piket') }}">
                                        @error('group_piket')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
