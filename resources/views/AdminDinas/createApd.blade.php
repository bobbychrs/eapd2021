            ...
            <div class="header-menu">
                ...
                <div class="col-sm-5">
                    <div class="user-area dropdown float-right">
                        <strong class="user-title">Admin Dinas</strong>
                        ...
                        <div class="card-body">
                            <form action="{{ route('simpan-apd') }}" method="post">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        <select name="jenis_apd" class="form-control" required="">
                                            <option value="">- pilih -</option>
                                            @foreach ($master_jenis_apd as $item)
                                                <option value="{{ $item->jenis_apd }}">{{ $item->jenis_apd }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
